...
mcPG(pg)
{
    ...
    */
    ...
    modeCmd->SetCandidates("Default 0nbb File nAIST565 nShield550 gAIST565_1.0.1 gAIST565_1.0.3 gAIST565_2.0.1 gAIST565_2.0.2 gAIST565_vertical gAIST565_vertical2");
