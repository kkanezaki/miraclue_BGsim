...
G4Allocator<DMXLSHit> DMXLSHitAllocator;
...
DMXLSHit::DMXLSHit(const DMXLSHit& right) : G4VHit(right){
  edep           = right.edep;
  prepos         = right.prepos;
...
const DMXLSHit& DMXLSHit::operator=(const DMXLSHit& right){
  edep           = right.edep;
  prepos         = right.prepos;
  postpos        = right.postpos;
  time           = right.time;
...
int DMXLSHit::operator==(const DMXLSHit& right) const{
