...
class DMXEventActionMessenger: public G4UImessenger {
 ...
 private:
  ...
  G4UIcmdWithAnInteger* SetLengthPrecisionCmd;
  G4UIcmdWithAnInteger* SetEnergyPrecisionCmd;
  G4UIcmdWithAnInteger* SetVectorPrecisionCmd;
  G4UIcmdWithAnInteger* SetTimingPrecisionCmd;
};
